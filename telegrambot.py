...
# eren 987004745
# emre 1572434674
# bilinmiyor 817741597, 1321541491,1274728384,
users = [1704449472, 1194185327, 987004745 ]
id_name = {
...
@client.on(events.NewMessage(chats=1194185327))  # (from_users=users)  chats=1194185327 chats=[1194185327, 1567439376, 1099086328]
